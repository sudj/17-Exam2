...
class Triangle(object):
    ...
    def shrink_or_expand(self, f):
        ...
        self.area_list = self.area_list + [self.area()]
    ...
    def return_doubled_triangle(self):
        ...
        point2 = self.b.clone()
        point3 = self.c.clone()
        double_point1 = Point(point1.x * 2, point1.y * 2)
        double_point2 = Point(point2.x * 2, point2.y * 2)
        double_point3 = Point(point3.x * 2, point3.y * 2)
        double_triangle = Triangle(double_point1, double_point2, double_point3)
    ...
    def get_largest_area(self):
        ...
        # ---------------------------------------------------------------------
        largest = 0
        for k in range(len(self.area_list)):
            if self.area_list[k] > largest:
                largest = self.area_list[k]
        return largest
